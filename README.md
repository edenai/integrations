...
Eden AI is a unified API for AI models and providers — Anthropic, OpenAI, Google, Mistral, and many more — with built-in smart routing, fallbacks, and cost tracking.

- [Documentation](https://www.edenai.co/docs)
